...
# Currently this file is largely for environments without direnv (e.g., our
# docker container) and first time setup. For daily development we should
# prefer .envrc for convenience. Maybe someday we'll migrate to direnv entirely.
