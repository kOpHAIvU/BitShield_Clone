...
usage() {
    ...
    echo ""
    echo "Examples:"
    echo "  # Build ResNet50 on CIFAR10 with no defense"
    echo "  $0 -m resnet50 -d CIFAR10 -I nd"
    echo ""
    echo "  # Build with gradient norm defense"
    echo "  $0 -m resnet50 -d CIFAR10 -I gn1"
    echo ""
    echo "  # Build with force rebuild"
    echo "  $0 -m resnet50 -d CIFAR10 -I nd -f"
    echo ""
    echo "  # Build multiple models"
    echo "  for model in resnet50 googlenet densenet121; do"
    echo "    $0 -m \$model -d CIFAR10 -I nd"
    echo "  done"
}
